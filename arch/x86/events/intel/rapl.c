...
static struct attribute *rapl_pmu_events_attrs[] = {
	NULL,
};

static struct attribute_group rapl_pmu_events_group = {
	.name = "events",
	.attrs = rapl_pmu_events_attrs,
};
...
const struct attribute_group *attr_groups_update[] = {
...
static int __init init_rapl_pmus(void)
{
	...
	rapl_pmus->pmu.attr_groups_update = rapl_attr_groups;
