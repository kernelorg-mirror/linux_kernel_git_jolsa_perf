 ...
 * * %-ERANGE - @s__ign is outside of kernel address space
 */
int bpf_strchr(const char *s__ign, char c)
{
 ...
 * * %-ERANGE - @s__ign is outside of kernel address space
 */
int bpf_strchrnul(const char *s__ign, char c)
{
	char sc;
	int i;
 ...
 * * %-ERANGE - One of the strings is outside of kernel address space
 */
int bpf_strstr(const char *s1__ign, const char *s2__ign)
{
 ...
 * * %-ERANGE - One of the strings is outside of kernel address space
 */
int bpf_strcasestr(const char *s1__ign, const char *s2__ign)
{
 ...
 * * %-ERANGE - One of the strings is outside of kernel address space
 */
int bpf_strnstr(const char *s1__ign, const char *s2__ign,
			    size_t len)
{
 ...
 * * %-ERANGE - One of the strings is outside of kernel address space
 */
int bpf_strncasestr(const char *s1__ign, const char *s2__ign,
				size_t len)
{
