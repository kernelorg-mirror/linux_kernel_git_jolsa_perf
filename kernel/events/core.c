...
static ssize_t
ru_event_attr_show(struct device *dev, struct device_attribute *attr,
		    char *page)
{
...
#define RU(__n, __e) \
PMU_EVENT_ATTR(__n, rusage_attr_##__n, __e, ru_event_attr_show);
...
PMU_EVENT_ATTR_STRING(maxrss.snapshot, rusage_attr_maxrss_snap, "1");
PMU_EVENT_ATTR_STRING(ixrss.snapshot,  rusage_attr_ixrss_snap,  "1");
PMU_EVENT_ATTR_STRING(idrss.snapshot,  rusage_attr_idrss_snap,  "1");
PMU_EVENT_ATTR_STRING(isrss.snapshot,  rusage_attr_isrss_snap,  "1");

static struct attribute*
rusage_events_attrs[PERF_RUSAGE_MAX + 4 /* *_snap */ + 1 /* NULL */] = {
