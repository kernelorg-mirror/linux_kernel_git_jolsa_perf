...
static int __init cputime_init(void)
{
	return perf_pmu_register(&perf_cputime, "cputime", -1);
}

module_init(cputime_init);

static void __exit cputime_exit(void)
{
	perf_pmu_unregister(&perf_cputime);
}

module_exit(cputime_exit);
