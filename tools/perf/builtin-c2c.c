...
static int c2c_header(struct perf_hpp_fmt *fmt, struct perf_hpp *hpp,
		      struct hists *hists __maybe_unused, int line, bool *defined)
{
	     ...
	     struct hist_entry *he)
{
	...
	return snprintf(hpp->buf, hpp->size, "0x%-*u", width, c2c_he->stats.t.store);
}
		   ...
		   struct hist_entry *he)
{
	...
	return snprintf(hpp->buf, hpp->size, "0x%-*u", width, c2c_he->stats.t.st_l1hit);
}
		    ...
		    struct hist_entry *he)
{
	...
	return snprintf(hpp->buf, hpp->size, "0x%-*u", width, c2c_he->stats.t.st_l1miss);
}
	       ...
	       struct hist_entry *he)
{
	...
	return snprintf(hpp->buf, hpp->size, "0x%-*u", width, c2c_he->stats.t.ld_fbhit);
}
	       ...
	       struct hist_entry *he)
{
	...
	return snprintf(hpp->buf, hpp->size, "0x%-*u", width, c2c_he->stats.t.ld_l1hit);
}
	       ...
	       struct hist_entry *he)
{
	...
	return snprintf(hpp->buf, hpp->size, "0x%-*u", width, c2c_he->stats.t.ld_l2hit);
}
		...
		struct hist_entry *he)
{
	...
	return snprintf(hpp->buf, hpp->size, "0x%-*u", width, c2c_he->stats.t.ld_llchit);
}
		...
		struct hist_entry *he)
{
	...
	return snprintf(hpp->buf, hpp->size, "0x%-*u", width, c2c_he->stats.t.rmt_hit);
}
		...
		struct hist_entry *he)
{
	...
	return snprintf(hpp->buf, hpp->size, "0x%-*" PRIu64, width, tot_recs);
}
...
static int __c2c_hists__init(struct c2c_hists *hists)
{
