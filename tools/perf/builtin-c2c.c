		     ...
		     struct perf_sample *sample)
{
	...
	c2c_hists = he__get_c2c_hists(he, "c2c_iaddr,symbol_iaddr,pid,cpu,dso", NULL);
	if (!c2c_hists)
		return NULL;
...
static int __setup_events(struct perf_session *session)
{
	...
	c2c.list_output = strdup("c2c_dcacheline,symbol_daddr,c2c_tot_recs");
	c2c.cl_sort     = strdup("c2c_offset");
	c2c.cl_output   = strdup("c2c_offset,c2c_iaddr,symbol_iaddr");
