			      ...
			      struct hists *hists, int line, bool *defined)
{
	...
	*defined = text != NULL;
	...
	return scnprintf(hpp->buf, hpp->size, "%-*.*s", len, len, text);
}
