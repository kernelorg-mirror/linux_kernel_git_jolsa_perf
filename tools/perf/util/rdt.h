...
struct rdt_config* rdt_config__alloc(struct rdt_config *templ);
int rdt_group__add(struct rdt_data *data, struct list_head *head);
int rdt_resource__add(struct rdt_data *data, struct list_head *head);
#endif /* __PERF_RDT_H */
