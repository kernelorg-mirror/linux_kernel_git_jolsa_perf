...
static inline int register_ftrace_direct(struct ftrace_ops *ops, unsigned long ip,
					 unsigned long addr)
{
	return -ENODEV;
}
static inline int unregister_ftrace_direct(struct ftrace_ops *ops, unsigned long ip,
					   unsigned long addr, bool free_filters)
{
	return -ENODEV;
}
static inline int modify_ftrace_direct(struct ftrace_ops *ops, unsigned long ip,
				       unsigned long addr)
{
	return -ENODEV;
}
static inline int modify_ftrace_direct_nolock(struct ftrace_ops *ops, unsigned long ip,
					      unsigned long addr)
{
	return -ENODEV;
}
